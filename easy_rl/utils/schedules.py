...
class LinearSchedule(object):
    def __init__(self, schedule_timesteps, final_val, initial_val=1.0):
        """Linear interpolation between initial_val and final_val over
        schedule_timesteps. After this many timesteps pass final_val is
        returned.

        Arguments:
            schedule_timesteps (int): Number of timesteps for which to linearly anneal initial_val to final_val.
            initial_val (float): initial output value.
            final_val (float): final output value.
        """
